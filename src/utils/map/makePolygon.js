...
export function makePolygon(tmpMap, naver, setPolygon) {
  const polygon1 = new naver.maps.Polygon({
    map: tmpMap,
    paths: [
      [126.43237125036256, 34.795362741543236],
      [126.43248312001636, 34.795226110168334],
  ...
  const polygon2 = new naver.maps.Polygon({
    ...
    paths: [
      ...
      [126.43308968001172, 34.795845586951064], // 왼쪽 아래
      [126.43337792671495, 34.79598284821558],

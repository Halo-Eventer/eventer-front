...
import { barrierFreeCategory, postCategory } from 'constants/Const_Assign';



function AssignPage_BarrierFree() {
  ...
  const [categoryList, setCategoryList]= useState(barrierFreeCategory);
  ...
  return (
    <Wrapper>
      <UpperBar_Component />
      <MiddleBar_Component2 id_param={id_param} text="배리어프리존" />
      <AssignBox>
...
export default AssignPage_BarrierFree;

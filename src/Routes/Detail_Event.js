...
function Detail_Event(){
    ...
    const DETAILURL = "http://3.34.24.140:9998/notice/1";
    ...
    //     useState([birthDay1,birthDay2,birthDay3,birthDay4]);
    ...
    //         setText1(response.data.title);
    //         setText2(response.data.subtitle);
    //         setText3(response.data.content);
            ...
            <MainBoard>
                <ImgBlock>
                    <StyledSlider {...settings}>
                        ...
                        {/* <ImgBoard src={birthDay1}></ImgBoard>
